...
const Button =()=>{
  ...
  return (
    ...
    <button id='change' className='bg-info text-white' onClick={Change}>button from component 1 clicked {count} times</button>
    <button id='change1' className='bg-info text-white' onClick={Change1}>button from component 2 clicked {count1} times</button>
    </>
